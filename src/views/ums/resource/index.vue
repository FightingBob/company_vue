  ...
  <div class="app-container">
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" size="small" @click="handleDialogConfirm('resourceForm')">确 定</el-button>
      </span>
    </el-dialog>
  </div>
</template>
    ...
    return {
      ...
      rules: {
        name: [
          ...
          { min: 6, max: 100, message: '长度在6到100个字符之间', trigger: 'blur' }
        ],
        url: [
        ...
        description: [
          ...
          { min: 6, max: 150, message: '长度在6到150个字符之间', trigger: 'blur' }
        ]
      }
    }
  },
